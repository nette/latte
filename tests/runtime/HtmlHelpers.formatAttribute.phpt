...
test('data attributes', function () {
	...
	Assert::same('data-foo', HtmlHelpers::formatAttribute('data-foo', true, compat: true));
	Assert::null(HtmlHelpers::formatAttribute('data-foo', false, compat: true));
	Assert::null(HtmlHelpers::formatAttribute('data-foo', null, compat: true));
	Assert::same('data-foo', HtmlHelpers::formatAttribute('data-foo', null, compat: false));
