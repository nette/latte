...
%A%
		echo '<ul>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->h2)(($this->filters->h1)($hello))) /* line %d% */;
		echo '</li>
	<li>';
		echo ($this->filters->h2)(($this->filters->h1)($hello)) /* line %d% */;
		echo '</li>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->h1)(($this->filters->h2)($hello))) /* line %d% */;
		echo '</li>
</ul>

<ul>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->types)((int) $hello * 0, 0, 0.0, '0')) /* line %d% */;
		echo '</li>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->types)((int) $hello * 1, 1, '1')) /* line %d% */;
		echo '</li>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->types)($hello, true, null, false)) /* line %d% */;
		echo '</li>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->types)($hello, true, null, false)) /* line %d% */;
		echo '</li>
	<li>';
		echo LR\HtmlHelpers::escapeText(($this->filters->types)($hello, '', '', "{$hello}")) /* line %d% */;
		echo '</li>
</ul>
