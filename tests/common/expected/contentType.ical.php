...
BEGIN:VEVENT
DTSTAMP:';
		echo LR\Helpers::escapeIcal(($this->filters->date)($start, 'Ymd\\THis')) /* line %d% */;
		echo '
DTSTART;TZID=Europe/Prague:';
		echo LR\Helpers::escapeIcal(($this->filters->date)($start, 'Ymd\\THis')) /* line %d% */;
		echo '
DTEND;TZID=Europe/Prague:';
		echo LR\Helpers::escapeIcal(($this->filters->date)($end, 'Ymd\\THis')) /* line %d% */;
		echo '
SUMMARY;LANGUAGE=cs:';
		echo LR\Helpers::escapeIcal($info) /* line %d% */;
		echo '
DESCRIPTION:
CLASS:PUBLIC
END:VEVENT
