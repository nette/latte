...
%A%
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 2:1 */ {
			...
			if (($ʟ_loc[0] ?? null) !== ($ʟ_tmp = [$i])) {
				$ʟ_loc[0] = $ʟ_tmp;
				echo ' ';
				echo LR\HtmlHelpers::escapeText($i) /* line 2:51 */;
				echo ' ';
...
';
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 6:1 */ {
			...
			if (($ʟ_loc[2] ?? null) !== ($ʟ_tmp = [$i])) {
				$ʟ_loc[2] = $ʟ_tmp;
				echo ' ';
				echo LR\HtmlHelpers::escapeText($i) /* line 6:51 */;
				echo ' ';
...
';
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 10:1 */ {
			...
			try /* line 10:36 */ {
				echo ' -';
				echo LR\HtmlHelpers::escapeText($i) /* line 10:49 */;
				echo '- ';
...
';
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 14:1 */ {
			...
			try /* line 14:36 */ {
				echo ' -';
				echo LR\HtmlHelpers::escapeText($i) /* line 14:49 */;
				echo '- ';
...
';
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 18:1 */ {
			...
			try /* line 18:42 */ {
				echo '<span>';
				echo LR\HtmlHelpers::escapeText($i) /* line 18:54 */;
				echo '</span>';
			} finally {
				$ʟ_tmp = ob_get_clean();
			}
...
';
		foreach ([1, 1, 2, 3, 3, 3] as $i) /* line 22:1 */ {
			...
			try /* line 22:55 */ {
				echo '<span ';
				echo LR\HtmlHelpers::formatAttribute('class', $i) /* line 22:42 */;
				echo '></span>';
			} finally {
				$ʟ_tmp = ob_get_clean();
			}
