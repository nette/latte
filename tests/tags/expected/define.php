...
';
		$this->renderBlock('test', ['var' => 20] + get_defined_vars(), 'html') /* line 7:1 */;
		echo '

';
		$this->renderBlock('true', get_defined_vars(), 'html') /* line 10:1 */;
	}
	...
	public function blockTest(array $ʟ_args): void
	{
		...
		echo LR\Filters::escapeHtmlText($var) /* line 4:22 */;
		echo "\n";
	}
