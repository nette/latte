...
<p';
		echo LR\HtmlHelpers::formatCommonAttribute(' val', $xss) /* line %d%:%d% */;
		echo ' > </p>
<p';
		echo LR\HtmlHelpers::formatCommonAttribute(' onclick', $xss) /* line %d%:%d% */;
		echo '> </p>
<p';
		echo LR\HtmlHelpers::formatCommonAttribute(' ONCLICK', $xss) /* line %d%:%d% */;
		echo ' ';
...
<p onclick=\'alert(';
		...
		echo ');alert("hello");\'';
		echo LR\HtmlHelpers::formatCommonAttribute('
 title', $xss) /* line %d%:%d% */;
		echo '
 STYLE="color:';
