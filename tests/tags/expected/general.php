...
';
		echo LR\HtmlHelpers::escapeText((string) (bool) (float) (int) (array) 10) /* line %d% */;
		echo '
...
';
		foreach ($iterator = $ʟ_it = new Latte\Essential\CachingIterator($menu, $ʟ_it ?? null) as $item) /* line %d% */ {
			echo '	<li>';
			echo LR\HtmlHelpers::escapeText($counter++) /* line %d% */;
			echo ' ';
			if (is_array($item)) /* line %d% */ {
				...
				echo LR\HtmlHelpers::escapeText($item) /* line %d% */;
			}
			echo '</li>
';
