...
Assert::match(
	<<<'XX'
		%A%
				...
				echo LR\Helpers::convertTo($ʟ_fi, 'html', $this->filters->filterContent('translate', $ʟ_fi, 'abc')) /* line 1:1 */;
		%A%
		XX,
...
Assert::contains(
	'echo LR\Helpers::convertTo($ʟ_fi, \'html\', $this->filters->filterContent(\'translate\', $ʟ_fi, \'abc\', 10, 20)) /* line 1:1 */;',
...
Assert::match(
	<<<'XX'
		%A%
				$ʟ_fi = new LR\FilterInfo('html');
				echo LR\Helpers::convertTo($ʟ_fi, 'html', $this->filters->filterContent('filter', $ʟ_fi, $this->filters->filterContent('translate', $ʟ_fi, 'abc'))) /* line 1:1 */;
		%A%
		XX,
...
Assert::match(
	<<<'XX'
		%A%
				...
				$ʟ_fi = new LR\FilterInfo('html');
				echo LR\Helpers::convertTo($ʟ_fi, 'html', $this->filters->filterContent('translate', $ʟ_fi, $ʟ_tmp)) /* line 1:1 */;
		%A%
		XX,
