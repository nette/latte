...
// invalid UTF-8
Assert::same('', Filters::escapeHtmlAttrConv("foo \u{D800} bar")); // invalid codepoint high surrogates
Assert::same('', Filters::escapeHtmlAttrConv("foo \xE3\x80\x22 bar")); // stripped UTF
