...
test('', function () {
	...
	Assert::exception(function () use ($latte) {
		$latte->renderToString('<meta content={include foo}>{block foo}{$value}{/block}', ['value' => 'b"ar']);
	}, Latte\CompileException::class, 'Including block foo with content type HTML into incompatible type HTMLTAG.');
...
<!--{block foo}{$foo}{/block}-->
	...
	}, Latte\CompileException::class, 'Overridden block foo with content type HTMLTAG by incompatible type HTML.');
	...
	}, Latte\CompileException::class, 'Overridden block foo with content type HTMLTAG by incompatible type HTMLCOMMENT.');
});
...
test('', function () {
	...
	}, Latte\CompileException::class, 'Including block style with content type HTMLCSS into incompatible type HTML.');
	...
	}, Latte\CompileException::class, 'Including block script with content type HTMLJS into incompatible type HTML.');
});
...
}, Latte\CompileException::class, "Including 'ical.latte' with content type ICAL into incompatible type HTML.");
...
}, Latte\CompileException::class, "Including 'ical.latte' with content type ICAL into incompatible type JS.");

Assert::exception(function () use ($latte) {
	$latte->renderToString('context7');
}, Latte\CompileException::class, "Including 'ical.latte' with content type ICAL into incompatible type HTMLCOMMENT.");
...
Assert::exception(function () use ($latte) {
	$latte->renderToString('context3');
}, Latte\CompileException::class, "Including 'js.latte' with content type JS into incompatible type HTMLTAG.");

Assert::same('<script> <\/script></script>', $latte->renderToString('context4'));

Assert::exception(function () use ($latte) {
	$latte->renderToString('context5');
}, Latte\CompileException::class, "Including 'js.latte' with content type JS into incompatible type HTMLCSS.");
...
Assert::exception(function () use ($latte) {
	$latte->renderToString('context3');
}, Latte\CompileException::class, "Including 'html.latte' with content type HTML into incompatible type HTMLTAG.");

Assert::exception(function () use ($latte) {
	$latte->renderToString('context4');
}, Latte\CompileException::class, "Including 'html.latte' with content type HTML into incompatible type HTMLJS.");

Assert::exception(function () use ($latte) {
	$latte->renderToString('context5');
}, Latte\CompileException::class, "Including 'html.latte' with content type HTML into incompatible type HTMLCSS.");
...
}, Latte\CompileException::class, 'Filter |upper is called with incompatible content type HTML, try to prepend |stripHtml.');
...
}, Latte\CompileException::class, 'Filter |stripHtml used with incompatible type HTMLCOMMENT');
