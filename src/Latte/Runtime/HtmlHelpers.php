...
use Nette;
use function get_debug_type, html_entity_decode, htmlspecialchars, implode, in_array, is_array, is_string, ord, preg_match, preg_replace, preg_replace_callback, str_contains, str_replace, strip_tags, strncmp, strtolower, strtr, substr;
...
final class HtmlHelpers
{
	...
	public static function formatAttribute(string $name, mixed $value): ?string
	{
		...
		return $name . '="' . self::escapeAttr($value) . '"';
	}
