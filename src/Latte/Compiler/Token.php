...
final class Token
{
	...
	public const
		...
		Php_Float = 304,
		Php_Identifier = 305,
		Php_StringVarname = 306,
		Php_Constant = 307,
		Php_Variable = 308,
		Php_NumString = 309,
		Php_EncapsedAndWhitespace = 310,
		Php_ConstantEncapsedString = 311,
		Php_Match = 312,
		Php_Default = 313,
		Php_Function = 314,
		Php_Fn = 315,
		...
		Php_Isset = 318,
		Php_Empty = 319,
		Php_ObjectOperator = 320,
		Php_NullsafeObjectOperator = 321,
		Php_UndefinedsafeObjectOperator = 322,
		Php_List = 323,
		Php_Array = 324,
		Php_StartHeredoc = 325,
		Php_EndHeredoc = 326,
		Php_DollarOpenCurlyBraces = 327,
		Php_CurlyOpen = 328,
		Php_PaamayimNekudotayim = 329,
		Php_NsSeparator = 330,
		Php_Ellipsis = 331,
		Php_ExpandCast = 332,
		Php_NameFullyQualified = 333,
		Php_NameQualified = 334,
		Php_Whitespace = 335,
		Php_Comment = 336,
		Php_Null = 337,
		Php_True = 338,
