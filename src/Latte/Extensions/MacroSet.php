...
class MacroSet implements Latte\Extension
{
	 ...
	 * @return bool|null
	 */
	public function nodeOpened(TagInfo $node)
	{
	 ...
	 * @return void
	 */
	public function nodeClosed(TagInfo $node)
	{
	 ...
	 * Generates code.
	 */
	private function compile(TagInfo $node, string|callable $def): string|bool|null
	{
